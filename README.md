...
Ceris White - Original (unmodified) tools in Pro_Tools folder, including arm9tool.py and synthesis_parser.py (lots of stuff in patch_synths.bat too)

darkobl4, Hoodinibobeenie - Compiling the synthesis recipes and testing
